defmodule ChatBubblesWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ChatBubblesWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ChatBubblesWeb.Gettext, "errors", msg, opts)
    end
  end
